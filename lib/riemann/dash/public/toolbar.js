var toolbar = (function() {
  ...
  var server_type = $('<div class="server"><label><input type="radio" id="ws" name="server_type" value="ws" checked>websockets</label>\
                      <input type="radio" id="sse" name="server_type" value="sse">sse</label>\
                      <input type="button" id="logout" name="logout" value="logout"></label></div>');
  form.append(pager);
